// 0x0070C0B0 @ 0x0070C0B0
// MoonSugarEffect decode: render/culling boundary for world camera sway. Camera object is consumed by SetCameraViewProj, NiCullingProcess::Process, and accumulator render; scoped call-site wrapper can mutate NiCamera for real world-space motion and restore immediately after.

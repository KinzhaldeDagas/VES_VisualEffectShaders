...
// MoonSugarEffect build 22: full Lighting30 pooled pass map extracted. B473D0[0..0x35] now maps to concrete B47288 SM3 vertex-program indices and B46ED8 normal pixel-program indices in OBSE diagnostics; still telemetry-only until an active SM3 contract is chosen.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

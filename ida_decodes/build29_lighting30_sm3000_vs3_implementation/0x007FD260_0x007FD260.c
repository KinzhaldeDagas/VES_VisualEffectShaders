...
// MoonSugarEffect build 29: selector 0x12D / pass 3 remains the only enabled Lighting30 SM3000 replacement route. vMask 0x00030002 and pMask 0x00000016 are preserved by using the post-native-setup direct D3D shader override instead of mutating pass maps.

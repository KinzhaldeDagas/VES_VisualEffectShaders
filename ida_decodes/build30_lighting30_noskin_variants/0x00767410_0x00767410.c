  ...
  if ( !result ) /*0x767347*/
  {
    ...
    if ( defaultShader->__vftable->Unk48((NiD3DShaderInterface *)defaultShader) ) /*0x767376*/
    {
      do /*0x7674ce*/
      {
        ...
        if ( v10->IB )                          // MoonSugarEffect build 30: post-flush direct D3D VS override now selects PAR/SKIN vs_2_0 or Lighting30 no-skin SM3 vs_3_0 variants per exact pass/wrapper contract; no pass object mutation. /*0x767412*/
        {
          v16 = 0; /*0x76741a*/
          v15 = 0; /*0x76741e*/

...
// MoonSugarEffect build 34 decode-only: visible auxiliary vertex contracts extracted for EnvMap B47288[8..12], Decal B47288[17], and TexEffect B47288[28..29]. These require dedicated clones; primary SM3Lighting VS source is not contract-compatible.

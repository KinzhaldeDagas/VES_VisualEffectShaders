...
// MoonSugarEffect build 28: SM3000.pso paired with SM3000.vso consumes Lighting30 tangent/position outputs; broader PS variants remain clone-only until their package contracts are decoded.

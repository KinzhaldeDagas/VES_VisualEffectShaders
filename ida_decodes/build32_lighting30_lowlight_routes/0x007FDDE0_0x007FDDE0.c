...
// MoonSugarEffect build 32: low-light SM3LL pixel routing decoded from Oblivion. B46C20[0..19] is aligned with normal B46ED8[0..19] SM3Lighting pixel indices and can consume the same primary B47288[0..7] vertex outputs; plugin now accepts matching low-light pixel wrappers without replacing native PS.

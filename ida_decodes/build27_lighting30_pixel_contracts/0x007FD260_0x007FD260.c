...
// MoonSugarEffect build 27: selector masks plus pass program contracts determine future replacement safety; raw selector route alone is insufficient without VS/PS contract readiness.

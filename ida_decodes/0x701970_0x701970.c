// 0x701970 @ 0x701970
// MoonSugarEffect decode: extracts NiCamera pos/right/up/forward/frustum/viewport and dispatches renderer SetupCamera when scene is active. Xrefs include water/reflection/misc/accumulator, so global detour needs tight filtering.

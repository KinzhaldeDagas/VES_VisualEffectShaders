  ...
  if ( !result ) /*0x767347*/
  {
    ...
    if ( defaultShader->__vftable->Unk48((NiD3DShaderInterface *)defaultShader) ) /*0x767376*/
    {
      do /*0x7674ce*/
      {
        ...
        if ( v10->IB )                          // MoonSugarEffect build 36: post-native D3D vertex shader override now supports primary SM3Lighting, EnvMap, and TexEffect clones without taking ownership of native pixel shaders/textures. /*0x767412*/
        {
          v16 = 0; /*0x76741a*/
          v15 = 0; /*0x76741e*/

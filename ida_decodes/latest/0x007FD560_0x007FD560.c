...
// MoonSugarEffect: Lighting30Shader vertex program loader fills global dword_B47288[0..0x1F] with SM3*.vso wrappers. Any Moon Sugar replacement for B473D0 must use a separate SM3 contract, not the PAR2016 contract.

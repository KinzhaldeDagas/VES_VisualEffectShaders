...
// MoonSugarEffect build 35: EnvMap runtime gating enabled only for exact B473D0[29..35] pass rows with matching B47288[8..12] VS wrappers and B46ED8[20..22] PS wrappers. No broad auxiliary replacement.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

...
// MoonSugarEffect build 21: IDA-observed Oblivion Lighting30 vertex loader. Loads exactly 0x20 SM3*.vso wrappers into 0x00B47288 for the inspected binary; OBSE telemetry maps matched CurrentPass+0x58 wrappers to these loader-order labels.

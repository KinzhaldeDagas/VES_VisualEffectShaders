...
// MoonSugarEffect build 35: EnvMap selectors 0x147..0x14D remain native alpha7 selector routes. Plugin does not mutate selector masks or pass maps; it applies a post-flush direct D3D vertex override.

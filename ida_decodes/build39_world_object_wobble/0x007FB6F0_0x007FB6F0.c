...
// MoonSugar build 38: selector-state byte gates are native constant-update state. Support-pass clones remain blocked unless a dedicated clone and exact render-target classification prove the support buffer should be deformed.

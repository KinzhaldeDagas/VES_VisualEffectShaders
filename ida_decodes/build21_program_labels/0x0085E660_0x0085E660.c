...
// MoonSugarEffect build 21: Lighting30 pass population binds B473D0 passes to the SM3 vertex/pixel wrapper tables. Runtime samples now print decoded VS/PS labels, keeping Lighting30 replacement diagnostic-only until the exact active shader contracts are proven.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

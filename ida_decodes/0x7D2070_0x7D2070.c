// 0x7D2070 @ 0x7D2070
// MoonSugarEffect decode: object-list render helper selects native shader IDs 0x10/0x14/0x154/0x155 based on object/shader-property state, then renders NiAVObjects through accumulator.

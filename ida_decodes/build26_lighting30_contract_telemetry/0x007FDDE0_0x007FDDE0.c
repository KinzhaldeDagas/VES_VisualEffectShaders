...
// MoonSugarEffect build 26: Lighting30 pixel loader mirrors normal SM3 pixel families in B46ED8 and low-light SM3LL subset in B46C20. OBSE uses this to distinguish normal and low pixel contracts in samples.

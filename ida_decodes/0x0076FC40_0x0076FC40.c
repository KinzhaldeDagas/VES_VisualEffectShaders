// 0x0076FC40 @ 0x0076FC40
// MoonSugarEffect decode: raw declaration element setter. Element record is 0x1C bytes; stream and slot are checked, semantic/type/usage/method fields are stored, declaration dirty byte +0x28 is set, cached D3D declaration +0x30 is released.

// 0x76FE20 @ 0x76FE20
// MoonSugarEffect decode: NiDX9ShaderDeclaration stream packer (+0x6C). Ensures declaration and stream stride, refreshes VB chips if stale/too small, writes vertex elements into the mapped VB, and unlocks when it owned the lock.

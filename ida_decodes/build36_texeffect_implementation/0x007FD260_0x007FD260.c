...
// MoonSugarEffect build 36: TexEffect selectors 0x15E..0x15F use alternate shader-slot route; OBSE clone activation is post-native setup and exact pass/wrapper-gated.

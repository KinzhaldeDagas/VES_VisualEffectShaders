...
// MoonSugarEffect build 35: EnvMap native pixel wrappers B46ED8[20..22] remain bound. OBSE replaces only the active D3D vertex shader after native setup, preserving NormalMap/EnvironmentCubeMap samplers and MatAlpha/PSLightColor pixel constants.

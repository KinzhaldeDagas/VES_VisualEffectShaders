...
// MoonSugarEffect build 29: SM3000.vso package contract is cloned as a plugin vs_3_0 shader for pass 3. It preserves POSITION/TEXCOORD/COLOR/TEXCOORD3-7 outputs and writes displaced position to both clip output and TEXCOORD6.

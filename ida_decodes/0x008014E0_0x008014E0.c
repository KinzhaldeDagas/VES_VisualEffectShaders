// 0x008014E0 @ 0x008014E0
// MoonSugarEffect decode: native vertex shader loader. Builds shader cache path, reads valid .vso or compiles HLSL main/profile with defines, creates IDirect3DVertexShader9, wraps it in 0x38-byte NiD3DVertexShader, and stores handle at wrapper +0x30. Success tail is 0x801B93 CreateVertexShader, 0x801BCC wrapper alloc, 0x801BF0 sub_780D80, 0x801C14 vtable +0x44 handle store.
...
LABEL_81:
  if ( v64 )
  {
    ...
    if ( !dword_B43104->member.device->lpVtbl->CreateVertexShader(dword_B43104->member.device, v64, &v90) ) /*0x801b93*/
    {
      v68 = (NiD3DShaderProgram *)FormHeapAlloc(0x38u); /*0x801bcc*/
      v86 = (int)v68; /*0x801bd4*/
      v100 = 0; /*0x801bda*/
      if ( v68 ) /*0x801be5*/
        v69 = sub_780D80(v68, (int)dword_B43104); /*0x801bf0*/
      else
        v69 = 0; /*0x801bf7*/

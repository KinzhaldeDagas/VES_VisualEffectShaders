...
// MoonSugarEffect decode: Lighting30Shader global pixel-program loader. Loads SM3*.pso variants into global pixel tables using lighting\3x and lighting\2x pixel HLSL; variant index/defines drive shared pass construction.

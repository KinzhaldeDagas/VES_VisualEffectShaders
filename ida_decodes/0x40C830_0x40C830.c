...
LABEL_51:
  ...
  sub_70C0B0(v81->camera, v81, cullingProcess, 0);// MoonSugarEffect decode: first main-world call to sub_70C0B0(camera, sceneGraph, cullingProcess, 0). Cdecl caller cleanup add esp,10h follows. Candidate scoped camera-sway wrapper site. /*0x40ccd3*/
  if ( sun ) /*0x40ccdd*/
...
LABEL_71:
  ...
  if ( !byte_B42CDB ) /*0x40cd8f*/
  {
    ...
    *((_BYTE *)v55 + 0x21E2) = 1; /*0x40ce34*/
    sub_70C0B0(v81->camera, (SceneGraph *)v83, cullingProcess, 0);// MoonSugarEffect decode: second main-world call to sub_70C0B0(camera, alternateSceneGraph, cullingProcess, 0) after accumulator setup. Candidate scoped camera-sway wrapper site. /*0x40ce48*/
    if ( sun ) /*0x40ce52*/

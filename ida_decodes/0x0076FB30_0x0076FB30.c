// 0x0076FB30 @ 0x0076FB30
// MoonSugarEffect decode: NiDX9ShaderDeclaration semantic helper. Converts Oblivion semantic ids to D3D usage/usageIndex and forwards to raw element setter (+0x4C).

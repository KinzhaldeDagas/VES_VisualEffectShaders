...
void __thiscall sub_864A60(_DWORD *this)
{
  ...
  v19 = (volatile LONG *)v313[0x37];            // MoonSugarEffect decode: Parallax pass 0 vertex bind uses object+0xDC / this[0x37] = PAR2016.vso. shaderpackage019.sdp offset 0x8C564, vs_2_0. Inputs consumed: v0 POSITION, v1 TANGENT, v2 BINORMAL, v3 NORMAL, v4 TEXCOORD; declared COLOR is unused. Outputs: oPos, oT0 base UV, oT1 tangent-space dir light, oT2 tangent-space point light, oT4 attenuation coords, oT7 tangent-space view vector. /*0x864dc3*/
  ...
  v21 = (volatile LONG *)v313[0x57];            // MoonSugarEffect decode: Parallax pass 0 pixel bind uses object+0x15C / this[0x57] = PAR2012.pso. shaderpackage019.sdp offset 0x997A0, ps_2_x. Pixel contract reads t0/t1/t2/t4/t7, BaseMap s0, NormalMap s1, AttenuationMap s4; t7 drives parallax UV offset, t4 drives attenuation, t1/t2 drive normal lighting. Replacement VS must recompute these from displaced position, not only change oPos. /*0x864e06*/

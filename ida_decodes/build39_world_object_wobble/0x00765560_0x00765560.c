// 0x00765560 @ 0x00765560
// MoonSugarEffect decode: skinned world/bone transform upload. Updates normal-scale state and renderer world matrix, then for <=4 blend matrices calls D3D SetTransform(D3DTS_WORLD+i) from calculated skin bone matrices. Higher-risk than non-skinned sub_765480 because skin/bone matrix ownership is shared with NiSkinInstance.

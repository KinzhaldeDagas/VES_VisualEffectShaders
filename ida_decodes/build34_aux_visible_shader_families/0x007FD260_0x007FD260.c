...
// MoonSugarEffect build 34 decode-only: selector routing gives EnvMap 0x147..0x14D and Decal 0x152..0x153 through alpha7, while TexEffect 0x15E..0x15F uses the alternate shader-slot branch copying +0x1F/+0x20 into active maps.

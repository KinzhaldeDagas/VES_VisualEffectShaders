...
// MoonSugarEffect build 28: SM3000.vso is the only currently decoded plain Lighting30 replacement candidate, paired through pass 3. Its actual bytecode contract must be mirrored separately from PAR2016.

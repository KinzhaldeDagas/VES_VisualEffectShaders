...
// MoonSugarEffect build 28: selector 0x12D routes to Lighting30 pass 3, the only plain SM3Lighting VS0/PS0 candidate. Selector masks still matter: pass 3 uses vMask 0x00030002 and pMask 0x00000016, so replacement must preserve the native constant-map/state gates.

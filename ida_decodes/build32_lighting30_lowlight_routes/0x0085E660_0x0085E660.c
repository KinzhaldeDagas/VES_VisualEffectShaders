...
// MoonSugarEffect build 32: Lighting30 pass map supplies the inspected-binary vertex/pixel indices. Runtime replacement accepts B47288[0..7] only, with pixel wrapper exact-gated to either normal B46ED8[index] or matching low-light B46C20[index]. Auxiliary EnvMap/SimpleShadow/etc. remain blocked.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

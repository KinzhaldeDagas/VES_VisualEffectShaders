// 0x7FD260 @ 0x7FD260
// MoonSugarEffect decode: native shader-id selector for higher/special IDs such as 0x154/0x155 and refraction/special offscreen IDs. Not a generic plugin mask allocator.

...
// MoonSugarEffect build 25: Lighting30 selector mask decode. Bits 1..5 toggle named VS constant-map entries; bits 6+ write selector-state bytes at B46964+(bit-1). Pixel bits write B46930[bit-1]. Selector also forces vertex bytes 16..18 and pixel bytes 5..7.

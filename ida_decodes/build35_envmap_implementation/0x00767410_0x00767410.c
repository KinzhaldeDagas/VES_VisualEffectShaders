  ...
  if ( !result ) /*0x767347*/
  {
    ...
    if ( defaultShader->__vftable->Unk48((NiD3DShaderInterface *)defaultShader) ) /*0x767376*/
    {
      do /*0x7674ce*/
      {
        ...
        if ( v10->IB )                          // MoonSugarEffect build 35: post-native-setup D3D vertex override now supports primary SM3Lighting plus visible EnvMap Lighting30 variants under exact wrapper gating. /*0x767412*/
        {
          v16 = 0; /*0x76741a*/
          v15 = 0; /*0x76741e*/

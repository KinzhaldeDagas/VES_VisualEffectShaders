// 0x0077FDE0 @ 0x0077FDE0
// MoonSugarEffect decode: NiDX9RenderState SetNormalization-style helper. Enables D3DRS_NORMALIZENORMALS (0x8F) when transform scale is non-unit or internal normalize flags are set; otherwise disables it.

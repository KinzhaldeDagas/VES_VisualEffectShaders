...
// MoonSugarEffect build 26: transform/constant update path shows Lighting30 replacement must respect different program families and selector-state update gates; no single generic object vertex shader is faithful across all B47288 indices.

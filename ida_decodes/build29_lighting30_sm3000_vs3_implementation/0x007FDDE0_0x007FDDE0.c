...
// MoonSugarEffect build 29: SM3000.pso remains native. The plugin only replaces the vertex shader, preserving the native pixel shader and its BaseMap/NormalMap/LightData sampler/constant ownership.

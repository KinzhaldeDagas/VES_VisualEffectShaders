...
// MoonSugarEffect build 55: selector-to-pass routing keeps replacement eligibility tied to decoded pass index, wrapper identity, and B46988/B46A60 constant masks. TexEffect selectors 0x15E..0x15F use the observed alternate shader-slot branch before routing.
char __cdecl sub_7FD260(unsigned __int16 a1)
{
  ...
  v16 = *(_DWORD *)(4 * v9 + 0xB46A60);         // DeferredRendering support contract: selector route applies B46988/B46A60 pixel mask rows. Runtime telemetry now reports support selector/mask/output-role and does not treat support-buffer writes as G-buffer candidates. /*0x7fd44b*/

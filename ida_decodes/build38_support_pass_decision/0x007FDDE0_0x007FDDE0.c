...
// MoonSugarEffect build 37: Decal native pixel wrappers B46ED8[24..25] remain bound. OBSE replaces only active D3D vertex shader after native setup, preserving DecalMap/BaseMap samplers and PSNumDecals/PSDecalOffsets constants.

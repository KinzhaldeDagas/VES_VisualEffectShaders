  ...
  if ( !result ) /*0x767347*/
  {
    ...
    if ( defaultShader->__vftable->Unk48((NiD3DShaderInterface *)defaultShader) ) /*0x767376*/
    {
      do /*0x7674ce*/
      {
        ...
        if ( v10->IB )                          // MoonSugarEffect build 29: post-SetupShaderPrograms/post-constant-flush hook now supports two exact direct-D3D replacement contracts: PAR2016/SKIN2008 vs_2_0 pass-0 and Lighting30 SM3000 pass-3 vs_3_0. Replacement remains after native setup and only for the current draw. /*0x767412*/
        {
          v16 = 0; /*0x76741a*/
          v15 = 0; /*0x76741e*/

...
// VES build59 fidelity note: clear support passes 47, 48, and 51 are observed in this Lighting30 pass-pool builder but are diagnostic-only for VES replacement; non-clear compatible support/visible passes remain exact-gated.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax
  ...
  dword_B46988[0] = 0x812;                      // DeferredRendering support contract: B473D0[0] ZOnly support pass, B47288[30]/B46ED8[37], vMask=0x00000812 pMask=0. Native-owned depth/occlusion writer; never deferred-lighting replacement. /*0x85e7dc*/
  ...
  dword_B4698C = 2;                             // MoonSugar build42: Lighting30 pass 1 ZOnly clone gate. B473D0[1] binds B47288[30]/SM3030 with B46ED8[37]/SM3037; vMask=0x00000002 pMask=0x00000000. /*0x85e901*/
  ...
  if ( v13 != (NiD3DPixelShader *)dword_B46F70 )// MoonSugar build42: Lighting30 pass 2 ZOnly SKIN clone gate. B473D0[2] binds B47288[31]/SM3031 with B46ED8[38]/SM3038; vMask=0x0000000C pMask=0x00000000. /*0x85e986*/
  {
    if ( v13 ) /*0x85e98a*/
    {
  ...
  v16 = dword_B47288[0];                        // DeferredRendering: SM3000 safe replacement gate starts from this pass-3 setup. Native table assigns B47288[0] as vertex wrapper before B46ED8[0] pixel wrapper. /*0x85ea6a*/
  ...
  sub_772CD0((_DWORD *)v0->RenderStateGroup, 7, 1, 0);// DeferredRendering depth/material edge: primary pass 3 sets D3DRS_ZENABLE=1. G-buffer capture keeps native depth test state from ApplyPassToRender. /*0x85eaf3*/
  if ( !v0->RenderStateGroup ) /*0x85eaf8*/
    v0->RenderStateGroup = (NiD3DRenderStateGroup *)sub_772DF0(); /*0x85eb02*/
  sub_772CD0((_DWORD *)v0->RenderStateGroup, 0x17, 4, 0);// DeferredRendering depth/material edge: primary pass 3 sets D3DRS_ZFUNC=4 (LESSEQUAL). Native draw can still pass after the capture draw writes matching depth. /*0x85eb0d*/
  if ( !v0->RenderStateGroup ) /*0x85eb12*/
    v0->RenderStateGroup = (NiD3DRenderStateGroup *)sub_772DF0(); /*0x85eb1c*/
  sub_772CD0((_DWORD *)v0->RenderStateGroup, 0xE, 1, 0);// DeferredRendering depth/material edge: primary pass 3 sets D3DRS_ZWRITEENABLE=1. Native-disabled replacement remains restricted to exact pass 3 because broader depth side effects are not proven. /*0x85eb27*/
  ...
  dword_B46994 = 0x30002;                       // DeferredRendering: pass-3 selector masks vMask=0x00030002 and pMask=0x00000016. Native draw disabling is allowed only for this exact SM3000 wrapper pair after successful per-draw resolve. /*0x85eb4b*/
  ...
  sub_7AECB0(v0, (NiD3DVertexShader *)dword_B472BC);// MoonSugar build43: Lighting30 pass 36 SimpleShadow clone gate. B473D0[36] binds B47288[13]/SM3013 with B46ED8[23]/SM3023; vMask=0x00030802 pMask=0x00000C10. /*0x861091*/
  ...
  sub_7AECB0(v0, (NiD3DVertexShader *)dword_B472C0);// MoonSugar build43: Lighting30 pass 37 SimpleShadow VC clone gate. B473D0[37] binds B47288[14]/SM3014 with B46ED8[23]/SM3023; vMask=0x00030802 pMask=0x00000C10. /*0x8611d8*/
  ...
  sub_7AECB0(v0, (NiD3DVertexShader *)dword_B472C4);// MoonSugar build43: Lighting30 pass 38 SimpleShadow SKIN clone gate. B473D0[38] binds B47288[15]/SM3015 with B46ED8[23]/SM3023; vMask=0x0003080C pMask=0x00000C10. /*0x86130d*/
  ...
  sub_7AECB0(v0, (NiD3DVertexShader *)dword_B472C8);// MoonSugar build43: Lighting30 pass 39 SimpleShadow SKIN VC clone gate. B473D0[39] binds B47288[16]/SM3016 with B46ED8[23]/SM3023; vMask=0x0003080C pMask=0x00000C10. /*0x861448*/
  ...
  sub_7AECB0(v107, (NiD3DVertexShader *)dword_B472D8);// DeferredRendering support contract: RenderNormals pass 44, B47288[20]/B46ED8[28], vMask=0x00000012 pMask=0x00000200. Writes encoded normal/refraction support data; kept native. /*0x86185c*/
  ...
  sub_7AECB0(v111, (NiD3DVertexShader *)dword_B472DC);// MoonSugarEffect build 42: RenderNormals pass 45 uses B47288[21] SM3021 SKIN with B46ED8[29]; support clone preserves SkinWorldViewTranspose normal output and uses c27-c28 scratch. /*0x86199a*/
  ...
  sub_7AECB0(v115, (NiD3DVertexShader *)dword_B472E0);// MoonSugarEffect build 42: RenderNormals FIRE pass 46 uses B47288[22] SM3022 with B46ED8[30]; support clone preserves fire vector/refraction power output. /*0x861ae5*/
  ...
  v118 = v145; /*0x861bfb*/
  sub_7AECB0((NiD3DPass *)v145, (NiD3DVertexShader *)dword_B472E4);// VES build59: RenderNormals CLEAR pass 47 binds B47288[23]/SM3023 with B46ED8[31]/SM3031. Clear pixel writes a constant value, so VES blocks live replacement as clearSupportPass. /*0x861c02*/
  ...
  v119 = v145; /*0x861cb9*/
  sub_7AECB0((NiD3DPass *)v145, (NiD3DVertexShader *)dword_B472E8);// VES build59: RenderNormals CLEAR SKIN pass 48 binds B47288[24]/SM3024 with B46ED8[32]/SM3032. Clear pixel writes a constant value, so VES blocks live replacement as clearSupportPass. /*0x861cc0*/
  ...
  sub_7AECB0(v134, (NiD3DVertexShader *)dword_B472D0);// DeferredRendering support contract: DepthMap pass 42, B47288[18]/B46ED8[26], vMask=0x00000012 pMask=0x00000400. Writes depth-like support data; kept native for buffer correctness. /*0x862169*/
  ...
  sub_7AECB0(v138, (NiD3DVertexShader *)dword_B472D4);// MoonSugarEffect build 41: DepthMap pass 43 uses B47288[19] SM3019 SKIN with B46ED8[26]; OBSE clone uses c27-c28 scratch and preserves SkinWorldView depth output. /*0x86228e*/
  ...
  v141 = v145; /*0x86234d*/
  sub_7AECB0((NiD3DPass *)v145, (NiD3DVertexShader *)dword_B472EC);// DeferredRendering support contract: LocalMap pass 49, B47288[25]/B46ED8[33], vMask=0x00000012 pMask=0. Writes local-map encoded normal/depth support data; kept native. /*0x862354*/
  ...
  v142 = v145; /*0x862422*/
  sub_7AECB0((NiD3DPass *)v145, (NiD3DVertexShader *)dword_B472F0);// MoonSugarEffect build 42: LocalMap SKIN pass 50 uses B47288[26] SM3026 with B46ED8[33]; support clone preserves skinned encoded normal/depth output. /*0x862429*/
  ...
  sub_7AECB0((NiD3DPass *)v145, (NiD3DVertexShader *)dword_B472F4);// VES build59: LocalMap CLEAR pass 51 binds B47288[27]/SM3027 with B46ED8[34]/SM3034. Clear pixel writes a constant value, so VES blocks live replacement as clearSupportPass. /*0x8624fb*/

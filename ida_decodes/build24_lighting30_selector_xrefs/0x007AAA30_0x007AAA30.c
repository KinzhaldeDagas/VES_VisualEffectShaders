...
// MoonSugarEffect decode: EndTargetGroup processes accumulator-owned refraction/special lists into dword_B474AC targets; useful pattern, not a generic Moon Sugar mask API.

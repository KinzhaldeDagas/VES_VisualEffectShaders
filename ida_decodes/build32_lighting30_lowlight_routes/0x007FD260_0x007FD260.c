...
// MoonSugarEffect build 32: selector/constant-mask path remains native. Low-light support is implemented only as an exact runtime pixel-wrapper allowance after native setup; no pass table or selector state is mutated.

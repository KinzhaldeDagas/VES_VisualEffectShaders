// 0x762640 @ 0x762640
// MoonSugarEffect decode: NiDX9Renderer SetCamera builds view/projection matrices from supplied camera basis/frustum and calls D3D SetTransform view/projection plus SetViewport.

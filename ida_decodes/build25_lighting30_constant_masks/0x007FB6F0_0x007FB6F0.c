...
// MoonSugarEffect build 25: Lighting30 transform/constant update slot. Observed B46964 byte 10 gates ViewProj constant group update, byte 21 gates object/world constant group update, and byte 27 gates skinned matrix constant group update.

// 0x00765480 @ 0x00765480
// MoonSugarEffect decode: non-skinned world-transform upload. Converts NiTransform into renderer world matrix at NiDX9Renderer+0x940 with camera-relative translation, optionally calls D3D SetTransform(D3DTS_WORLD), updates normal-scale render state, and caches model-camera vectors. Hooking this with a local transform copy is the lowest-risk true non-skinned object motion point.

...
// MoonSugarEffect build 37: Decal runtime gating enabled only for exact B473D0[40..41] rows with matching B47288[17] VS wrapper and B46ED8[24..25] PS wrappers.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

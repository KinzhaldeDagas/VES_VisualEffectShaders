...
// MoonSugarEffect build 36: TexEffect runtime gating enabled only for exact B473D0[52..53] rows with matching B47288[28..29] VS wrappers and B46ED8[35..36] PS wrappers.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

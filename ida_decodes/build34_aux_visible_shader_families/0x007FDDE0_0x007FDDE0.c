...
// MoonSugarEffect build 34 decode-only: visible auxiliary pixel contracts extracted. EnvMap B46ED8[20..22] consumes normal/cube reflection inputs, Decal B46ED8[24..25] consumes projected decal/fade outputs, TexEffect B46ED8[35..36] consumes UV/view/fog-color outputs.

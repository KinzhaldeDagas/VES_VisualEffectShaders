...
// MoonSugarEffect build 36: TexEffect native pixel wrappers B46ED8[35..36] remain bound. OBSE replaces only active D3D vertex shader after native setup, preserving NormalMap/SourceTexture samplers and FillColor/RimColor/fVars pixel constants.

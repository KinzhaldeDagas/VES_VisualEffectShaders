...
// MoonSugarEffect build 34 decode-only: visible auxiliary pass map is EnvMap passes 29..35, Decal passes 40..41, TexEffect passes 52..53. Runtime clone enabling must exact-gate pass index plus current VS/PS wrappers.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

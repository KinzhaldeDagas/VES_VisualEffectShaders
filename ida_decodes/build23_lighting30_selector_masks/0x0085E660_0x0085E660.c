...
// MoonSugarEffect build 23: in addition to the B473D0 pass->SM3 program map, the B46988/B46A60 selector masks are now encoded in OBSE diagnostics as raw vMask/pMask values for top Lighting30 passes.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

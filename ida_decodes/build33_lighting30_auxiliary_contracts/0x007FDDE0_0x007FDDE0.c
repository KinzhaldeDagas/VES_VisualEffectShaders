...
// MoonSugarEffect build 33 decode-only: auxiliary normal pixel families B46ED8[20..38] pair with B47288[8..31]. Primary SM3Lighting/SM3LL support remains vertex-only replacement; auxiliary pixel families stay native and blocked until VS/PS contracts are separately validated.

...
// MoonSugarEffect build 24: selector ID route decoded. Pass 0 uses 0x12A; pass 1/2 have direct aliases 4/5 plus primary 0x12B/0x12C; pass 1..0x2B use alpha7 route, 0x2C..0x33 alpha15 route, 0x34..0x35 alternate shader-slot route.

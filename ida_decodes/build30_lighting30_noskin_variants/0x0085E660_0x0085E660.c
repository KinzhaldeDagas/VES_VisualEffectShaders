...
// MoonSugarEffect build 30: OBSE replacement now supports exact no-skin Lighting30 B473D0 passes whose current wrappers match B47288[0/2/4/6] and normal B46ED8 SM3Lighting PS wrappers. Low-light and skinned variants remain blocked.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

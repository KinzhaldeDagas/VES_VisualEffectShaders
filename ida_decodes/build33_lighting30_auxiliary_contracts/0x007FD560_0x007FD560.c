...
// MoonSugarEffect build 33 decode-only: auxiliary B47288[8..31] contracts extracted from shaderpackage019.sdp. EnvMap, SimpleShadow, Decal, DepthMap, RenderNormals, LocalMap, TexEffect, and ZOnly have distinct VS outputs/register pressure and remain blocked until dedicated clones are implemented.

...
// MoonSugarEffect build 21: IDA-observed Oblivion Lighting30 pixel loader. Loads 0x27 normal SM3*.pso wrappers into 0x00B46ED8, but only first 0x14 SM3LL*.pso low-light wrappers into 0x00B46C20 for the inspected binary; OBSE count corrected to 0x14.

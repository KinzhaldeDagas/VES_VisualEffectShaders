...
// MoonSugarEffect decode: Lighting30Shader global vertex-program loader. Loads 0x20 SM3*.vso variants into global table 0x00B47288 from lighting\3x and lighting\2x vertex HLSL with SKIN/VC/PROJSHADOW/SM3/etc defines.

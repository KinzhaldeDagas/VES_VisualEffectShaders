...
// MoonSugarEffect build 30: native B46ED8 pixel programs remain bound. Vertex-only no-skin SM3 replacements preserve pixel input contracts for SM3000/SM3002/SM3004/SM3006 families.

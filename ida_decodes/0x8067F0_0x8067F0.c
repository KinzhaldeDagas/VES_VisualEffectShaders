...
int __thiscall sub_8067F0(unsigned int *this, _DWORD *a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  ...
  (*(void (__thiscall **)(unsigned int *))(*this + 0x80))(this);// MoonSugarEffect decode: Parallax render selector begins by calling vtable +0x80 = NiD3DShader_RemoveShaderPasses. This clears the previous shader pass list before selecting/appending the current material pass. /*0x806822*/
...
LABEL_32:
  ...
  {
    case 0x4Cu: /*0x806a57*/
      sub_8736F0(this, (int)a2, a3, a5, v12);   // MoonSugarEffect decode: dword_B42E90 == 0x4C selects the first Parallax helper sub_8736F0 and sets selected ordinal v21=0. This is the whitelisted PAR2016/PAR2012 pass-0 path. /*0x806a68*/
      v21 = 0; /*0x806a6d*/

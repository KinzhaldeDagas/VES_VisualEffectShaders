  ...
  if ( !result ) /*0x767347*/
  {
    ...
    if ( defaultShader->__vftable->Unk48((NiD3DShaderInterface *)defaultShader) ) /*0x767376*/
    {
      do /*0x7674ce*/
      {
        ...
        if ( v10->IB )                          // MoonSugarEffect build 31: post-flush direct D3D SetVertexShader hook remains the late-safe replacement point. It now selects PAR/SKIN vs2 plus Lighting30 primary SM3 no-skin and skinned variants after Oblivion has chosen the exact pass wrapper. /*0x767412*/
        {
          v16 = 0; /*0x76741a*/
          v15 = 0; /*0x76741e*/

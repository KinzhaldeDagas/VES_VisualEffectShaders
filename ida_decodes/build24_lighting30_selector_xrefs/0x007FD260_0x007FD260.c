...
// MoonSugarEffect build 23: Lighting30 selector consumes B46988/B46A60 per-pass masks written by sub_85E660, toggles constant-map/state booleans, then chooses B473D0 pass 4/5 or special B46F28 entries. OBSE diagnostics now logs raw vMask/pMask and checks runtime samples against the static pass map.
char __cdecl sub_7FD260(unsigned __int16 a1)
{
  ...
  {
    sub_55E2A0(shader + 0xB, shader + 0x1F); /*0x7fd290*/
    sub_55E2A0(shader + 0xC, shader + 0x20); /*0x7fd29f*/
  }
  else
  {

...
// MoonSugarEffect build 27: pass population now feeds OBSE telemetry for combined Lighting30 VS+PS contract readiness. Only plain no-skin SM3Lighting VS paired with plain SM3Lighting PS is marked a future candidate; variants remain diagnostic-only.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

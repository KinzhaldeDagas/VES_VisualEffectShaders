...
// MoonSugarEffect build 31: B473D0 pass population observed as the source for runtime wrapper pairing in the inspected binary. Plugin replacement exact-gates the active VS wrapper against B47288[0..7] and PS wrapper against the normal SM3Lighting B46ED8 family before replacing vertex shaders.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

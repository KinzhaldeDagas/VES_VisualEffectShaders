...
// MoonSugarEffect build 33 decode-only: Lighting30 pass map is sufficient to identify auxiliary pass families, but no broad auxiliary replacement is enabled. Visible next candidates are EnvMap/TexEffect/Decal; depth/shadow/support families need runtime-risk review before wobble clones.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

// 0x007830C0 @ 0x007830C0
// MoonSugarEffect decode: NiD3DVertexShader constant setter. Uses constant entry type table to choose D3D SetVertexShaderConstantB/I/F slots 0x188/0x180/0x178.

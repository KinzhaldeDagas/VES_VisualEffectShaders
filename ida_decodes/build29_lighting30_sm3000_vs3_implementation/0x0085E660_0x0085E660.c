...
// MoonSugarEffect build 29: Lighting30 B473D0[3] is now the first full non-rigid SM3 implementation target. OBSE gates it to the exact B47288[0] SM3000.vso + B46ED8[0] SM3000.pso wrapper pair before binding the plugin vs_3_0 clone.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax

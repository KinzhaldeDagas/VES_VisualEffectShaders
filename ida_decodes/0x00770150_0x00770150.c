// 0x00770150 @ 0x00770150
// MoonSugarEffect decode: emits one D3DVERTEXELEMENT9 from an internal declaration element and returns that element's byte size for stride accumulation.

...
// MoonSugarEffect build 28: largest remaining Lighting30 replacement gap narrowed. The decoded pass map shows only B473D0[3] is plain no-skin SM3Lighting VS0 + plain SM3Lighting PS0; all other Lighting30 object passes require variant-specific clones or non-lighting auxiliary contracts.
void sub_85E660()
{
  NiD3DPass *v0; // esi
  int v1; // eax
